...
namespace Crystal {
	...
	Camera::Camera(int width, int height)
	{
		...
		XMStoreFloat4x4(&m_InverseViewProjection, DirectX::XMMatrixIdentity());
	...
	void Camera::generateViewProjection()
	{
		...
		DirectX::XMMATRIX viewProjection = XMMatrixTranspose(DirectX::XMMatrixMultiply(DirectX::XMMatrixLookAtLH(position, lookAt, DirectX::XMVectorSet(0.0f, 1.0f, 0.0f, 0.0f)),
