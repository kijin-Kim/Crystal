...
namespace Crystal {
	...
	ConstantBufferPoolManager* ConstantBuffer::s_ConstantBufferPoolManager = nullptr;
	...
	ConstantBufferData ConstantBufferPool::CreateConstantBuffer()
	{
		auto device = Renderer::Instance().GetDevice();
	...
	ConstantBufferData ConstantBufferPoolManager::CreateConstantBuffer(int size)
	{
